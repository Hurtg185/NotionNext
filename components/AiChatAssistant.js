// /components/AiChatAssistant.js - v52 (最终完整版 - 修复所有已知Bug，采用“报名课程”背景图激活界面)
    ...
    if (activationState !== 'activated') {
        return (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-cover bg-center" style={{ backgroundImage: `url('/images/jihuomatu.jpg')` }}>
                ...
                <div className="relative w-full max-w-sm bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg shadow-xl p-8 flex flex-col items-center animate-scale-in">
