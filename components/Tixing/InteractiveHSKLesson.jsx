    ...
    <div className="fixed inset-0 w-screen h-screen bg-slate-50 flex flex-col overflow-hidden font-sans" style={{ touchAction: 'none' }}>
      ...
      {!hideBottomNav && (
        ...
        >
            ...
            <button 
              onClick={goNext}
              className="pointer-events-auto w-14 h-14 rounded-full flex items-center justify-center border border-slate-100 shadow-lg transition-all bg-white text-slate-600 hover:bg-slate-50 active:scale-95"
            >
