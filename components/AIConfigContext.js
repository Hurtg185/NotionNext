...
0️⃣ 🌟 情境导入（缅文）
1. 用缅文描述一个具体的 Ko Ko 和 Ma Ma 的生活场景（如食堂、宿舍）。
2. 给出一句包含【本课语法点】的自然对话。
3.让学生立刻知道：**我什么时候会用这句话**
...
2️⃣ 📊 语序对照表（重点）
- 用3-5句「缅甸语 vs 中文」对照
绘制一个 Markdown 表格，包含四列：
| 中文正确句 | 缅语直译(❌) | 中文结构公式 | 缅文思维差异说明 |
(重点对比 SOV vs SVO 的语序差异)
