...
- 告诉学生：遇到[XX场景]，直接扔出这一句，中国人绝对听得懂。例句用中文，说明用缅文
...
【核心工作逻辑】
  分析错因，找出学生选 {{USER_CHOICE}} 的思维漏洞（用地道缅甸口语 + 中文关键词解释）
   - 对比正误选项的语义/语法差异，找出学生选 {{USER_CHOICE}} 的思维漏洞
   - 对比正误选项的语义/语法差异，
   场景对比：
   - 用1个生活场景展示错误用法会造成的误解
   - 再用同一场景展示正确用法
    巩固提问：
   - 生成3个引导性问题，帮助学生自己发现规律
