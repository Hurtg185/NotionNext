...
const PinyinSection = ({ onOpenTips, onOpenVocab, onOpenCollection }) => {
    return (
        <div className="relative overflow-hidden rounded-[2.5rem] border border-white/20 dark:border-slate-700 shadow-2xl">
            ...
            <div className="relative z-10 p-8">
                <div className="flex items-center justify-between mb-6 px-2">
                    ...
                    <span className="text-[10px] font-bold text-slate-400/80 uppercase tracking-widest border border-slate-200 dark:border-slate-700 px-2 py-1 rounded-lg">Basis & Tools</span>
                </div>
                ...
                <div className="pt-6 border-t border-slate-200/50 dark:border-slate-700/50">
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <button 
                            onClick={onOpenTips}
                            className="flex items-center gap-3 px-4 py-4 rounded-2xl bg-indigo-50 dark:bg-indigo-900/20 hover:bg-indigo-100 dark:hover:bg-indigo-900/40 transition-colors group"
                        >
                            <div className="p-2 bg-indigo-100 dark:bg-indigo-800 rounded-xl text-indigo-600 dark:text-indigo-300">
                                <HelpCircle size={18} />
                            </div>
                            <div className="text-left">
                                <p className="text-xs font-black text-slate-800 dark:text-slate-100">拼音技巧</p>
                                <p className="text-[10px] text-slate-500 font-bold">发音规则说明</p>
                            </div>
                        </button>
                        ...
                        <button 
                            ...
                            className="flex items-center gap-3 px-4 py-4 rounded-2xl bg-pink-50 dark:bg-pink-900/20 hover:bg-pink-100 dark:hover:bg-pink-900/40 transition-colors group"
                        >
                            <div className="p-2 bg-pink-100 dark:bg-pink-800 rounded-xl text-pink-600 dark:text-pink-300">
                                <Heart size={18} fill="currentColor" />
                            </div>
                            <div className="text-left">
                                <p className="text-xs font-black text-slate-800 dark:text-slate-100">收藏生词</p>
                                <p className="text-[10px] text-slate-500 font-bold">我的单词本</p>
                            </div>
                        </button>

                        {/* HSK 1 单词 */}
                        <button 
                            onClick={() => onOpenVocab(1)}
                            className="flex items-center gap-3 px-4 py-4 rounded-2xl bg-cyan-50 dark:bg-cyan-900/20 hover:bg-cyan-100 dark:hover:bg-cyan-900/40 transition-colors group"
                        >
                            <div className="p-2 bg-cyan-100 dark:bg-cyan-800 rounded-xl text-cyan-600 dark:text-cyan-300">
                                <BookOpen size={18} />
                            </div>
                            <div className="text-left">
                                <p className="text-xs font-black text-slate-800 dark:text-slate-100">HSK 1 词汇</p>
                                <p className="text-[10px] text-slate-500 font-bold">150个基础词</p>
                            </div>
                        </button>

                        {/* HSK 2 单词 */}
                        <button 
                            onClick={() => onOpenVocab(2)}
                            className="flex items-center gap-3 px-4 py-4 rounded-2xl bg-orange-50 dark:bg-orange-900/20 hover:bg-orange-100 dark:hover:bg-orange-900/40 transition-colors group"
                        >
                            <div className="p-2 bg-orange-100 dark:bg-orange-800 rounded-xl text-orange-600 dark:text-orange-300">
                                <GraduationCap size={18} />
                            </div>
                            <div className="text-left">
                                <p className="text-xs font-black text-slate-800 dark:text-slate-100">HSK 2 词汇</p>
                                <p className="text-[10px] text-slate-500 font-bold">300个进阶词</p>
                            </div>
                        </button>
                    </div>
                </div>
...
export default function HskPageClient() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-[#0a0a0a] pb-32 relative overflow-x-hidden">
            ...
            <header className="relative pt-10 pb-12 overflow-visible">
                ...
                <div className="px-4 z-20 relative">
                    <div className="max-w-xl mx-auto transform hover:-translate-y-1 transition-transform duration-500">
                        <PinyinSection 
                            ...
                            onOpenVocab={handleVocabularyClick}
                        />
                    </div>
                </div>
            </header>
