...
import {
    ...
    Gem, MessageCircle, X, CheckCircle2, ShieldCheck, Globe2
} from 'lucide-react';
...
const getLevelPrice = (level) => {
    ...
    return prices[level] || "ဆက်သွယ်ရန်"; // 联系客服
};
...
const pinyinMain = [
    ...
    { id: 'whole', title: '整体认读', sub: 'အသံတွဲ', href: '/pinyin/whole', icon: Layers, color: 'text-purple-600', bg: 'bg-purple-50' },
...
const hskData = [
    {
        level: 1, title: '入门水平', subTitle: 'အခြေခံအဆင့် (၁)', description: '掌握最常用词语和基本语法',
        imageUrl: 'https://images.unsplash.com/photo-1548126049-2e2e92c57802?w=800&q=80',
        lessons: [
    ...
    {
        level: 2, title: '基础水平', subTitle: 'အခြေခံအဆင့် (၂)', description: '就熟悉的日常话题进行交流',
        imageUrl: 'https://images.unsplash.com/photo-1512413391786-fb9a3d4f35e6?w=800&q=80',
        lessons: [
    ...
    {
        level: 3, title: '进阶水平', subTitle: 'အလယ်အလတ်အဆင့်', description: '完成生活、学习、工作的基本交际',
        imageUrl: 'https://images.unsplash.com/photo-1541257127-14e3006248c9?w=800&q=80',
        lessons: Array.from({ length: 20 }, (_, i) => ({ id: i + 1, title: `第 ${i + 1} 课 进阶内容展示` }))
    },
    {
        level: 4, title: '中级水平', subTitle: 'အလယ်အလတ်အဆင့် (၂)', description: '流畅地与母语者进行交流',
        imageUrl: 'https://images.unsplash.com/photo-1557002665-c579822a16d8?w=800&q=80',
        lessons: Array.from({ length: 20 }, (_, i) => ({ id: i + 1, title: `第 ${i + 1} 课 中级内容展示` }))
    },
    {
        level: 5, title: '高级水平', subTitle: 'အဆင့်မြင့်', description: '阅读报刊杂志，欣赏影视节目',
        imageUrl: 'https://images.unsplash.com/photo-1460501602446-f2893f443b74?w=800&q=80',
        lessons: Array.from({ length: 36 }, (_, i) => ({ id: i + 1, title: `第 ${i + 1} 课 高级内容展示` }))
    },
    {
        level: 6, title: '流利水平', subTitle: 'ကျွမ်းကျင်အဆင့်', description: '轻松理解信息，流利表达观点',
        imageUrl: 'https://images.unsplash.com/photo-1496263592395-69b76c117d84?w=800&q=80',
            ...
            >
                ...
                <div className="px-6 pb-8 -mt-10 relative">
                    ...
                    <div className="text-center mb-6">
                        <h2 className="text-2xl font-black text-gray-800">解锁 HSK {targetLevel}</h2>
                        <p className="text-gray-500 text-xs font-myanmar mt-1">အဆင့် {targetLevel} သင်ခန်းစာများအားလုံးကို လေ့လာပါ</p>
                    </div>

                    <div className="bg-orange-50 rounded-2xl p-5 border border-orange-100 mb-6">
                        <div className="flex justify-between items-center mb-3">
                            <span className="text-sm font-bold text-gray-600 font-myanmar">သင်တန်းကြေး (费用)</span>
                            <span className="text-xl font-black text-orange-600">{price}</span>
                        </div>
                        <div className="space-y-2.5">
                            <div className="flex items-center gap-2 text-xs text-gray-600 font-myanmar">
                                <CheckCircle2 size={14} className="text-green-500 shrink-0" /> ဗီဒီယိုနှင့် သင်ခန်းစာများ အကန့်အသတ်မရှိ
                            </div>
                            <div className="flex items-center gap-2 text-xs text-gray-600 font-myanmar">
                                <CheckCircle2 size={14} className="text-green-500 shrink-0" /> ထာဝရအသုံးပြုခွင့် (Lifetime Access)
                            </div>
                            <div className="flex items-center gap-2 text-xs text-gray-600 font-myanmar">
                                <CheckCircle2 size={14} className="text-green-500 shrink-0" /> မေးခွန်းဟောင်းများနှင့် လေ့ကျင့်ခန်းများ
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        >
                            ...
                            <span className="font-myanmar text-sm">Messenger မှ ဝယ်ယူရန်</span>
                        </a>
                        <p className="text-[10px] text-center text-gray-400 font-myanmar">
                            ငွေပေးချေပြီးပါက ဆရာမှ သင်ခန်းစာများကို ဖွင့်ပေးပါမည်
                        </p>
                    </div>
                </div>
            </motion.div>
            ...
            <div className="h-40 relative overflow-hidden group">
                ...
                <div className="absolute bottom-4 left-6 text-white">
                    <div className="flex items-baseline gap-2">
                        ...
                        <span className="text-sm font-myanmar opacity-90 text-amber-300">{level.subTitle}</span>
                    </div>
                    <p className="text-xs font-medium text-white/80">{level.title}</p>
                </div>
            </div>
        ...
        <div className="min-h-screen bg-[#f8fafc] pb-24 font-sans">
            ...
            <div className="h-72 w-full relative">
                <div className="absolute inset-0">
                    ...
                    />
                    {/* 红色渐变蒙层 */}
                    <div className="absolute inset-0 bg-gradient-to-b from-red-900/60 via-red-800/40 to-[#f8fafc]" />
                </div>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pt-8 text-white z-10">
                    ...
                    >
                        ...
                        <p className="text-white/90 font-myanmar text-sm font-medium tracking-wide bg-black/10 backdrop-blur-sm px-4 py-1.5 rounded-full inline-block border border-white/20">
                            တရုတ်စာ အွန်လိုင်း သင်တန်းကျောင်း
                        </p>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto px-5 -mt-24 relative z-20 space-y-10">
                ...
                <div className="space-y-6">
                    <div className="flex flex-col gap-1 px-2">
                        ...
                        <p className="text-gray-500 text-xs font-myanmar">အခြေခံမှ စ၍ ကျွမ်းကျင်အဆင့်ထိ လေ့လာနိုင်ပါသည်</p>
                    </div>
