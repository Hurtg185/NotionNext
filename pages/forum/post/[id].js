// pages/forum/post/[id].js (修复 allComments is not defined 和刷新白屏问题)
...
// 【修复】CompactReply 组件，接收 allComments prop
...
const PostDetailPage = () => {
  ...
  const { user, userData, loading: authLoading } = useAuth(); // 【修改】获取 authLoading
  const [post, setPost] = useState(null);
  const [comments, setComments] = useState([]);
  const [dataLoading, setDataLoading] = useState(true); // 【修改】使用 dataLoading 区分
