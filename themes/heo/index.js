/**
 *   HEO 主题说明
 *  > 此文件已强制设为手机端显示模式，隐藏价格，移除私信功能，并修复了 SP 激活逻辑。
 */
                ...
                {!user ? (
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="bg-white dark:bg-gray-800 p-3 rounded-xl border border-gray-100 dark:border-gray-600 shadow-sm">
                            ...
                            <button onClick={handleActivate} disabled={loading || !code} className="w-full bg-blue-600 text-white py-1.5 rounded-lg text-xs font-medium">{loading ? '验证中...' : '立即激活'}</button>
...
const PriceChartDisplay = () => {
    const courses = [
        { id: 1, title: 'HSK 1', image: 'https://audio.886.best/chinese-vocab-audio/%E5%9B%BE%E7%89%87/IMG_20251219_162925.png' },
        { id: 2, title: 'HSK 2', image: 'https://audio.886.best/chinese-vocab-audio/%E5%9B%BE%E7%89%87/IMG_20251219_162958.png' },
        { id: 3, title: '口语课', image: 'https://audio.886.best/chinese-vocab-audio/%E5%9B%BE%E7%89%87/IMG_20251219_162958.png' }
    ];
