// lib/chat.js (完整修复版 - 已添加 getNotificationsForUser)
...
// ... (startChat, getConversationsForUser, getMessagesForChat, sendMessage 函数保持不变) ...
...
/**
 * 获取指定用户的所有通知
 * @param {string} userId - 当前登录用户的 UID
