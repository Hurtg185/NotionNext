...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '梅峰', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '学中文', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly102428.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '学中文', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'ကြိုဆိုပါတယ်။ မြန်မာလူမျိုးများအတွက် အထူးရည်ရွယ်ဖန်တီးထားတဲ့ တရုတ်စာ လေ့လာရေး ပလက်ဖောင်းပါ။',
