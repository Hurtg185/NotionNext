...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '轻松学中文', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '梅峰', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '轻松学中文, 梅峰', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '大家好，我是一个程序员, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
